...
export class RegisterScreen extends Component {
  ...
  _handleRegisterUser = event =>{
    ...
    Axios.post('https://evidyadaan-backend.herokuapp.com/auth/local/register',{user1})
 ...
 /* _redirectToServiceListScreen = () => {
    const { navigation } = this.props;
    navigation.navigate("ServiceList");
  };*/

  _redirectToUserBooking = () => {
    const { navigation } = this.props;
